...
// Get all students
router.get("/students", /*#__PURE__*/function () {
...
// Get all teachers
router.get("/teachers", /*#__PURE__*/function () {
...
router.get("/profile", /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _context4.prev = 1;
          _context4.t0 = role;
          _context4.next = _context4.t0 === "admin" ? 5 : _context4.t0 === "teacher" ? 9 : _context4.t0 === "student" ? 13 : 17;
          break;
        case 5:
          _context4.next = 7;
          return _Admin["default"].findById(userId).select("-password").lean();
        case 7:
          user = _context4.sent;
...
router.get("/show-profile", /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var user, extraData, courses, attendanceRecords, totalClasses, attendedClasses;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.prev = 0;
          user = null;
          extraData = {}; // 🔹 Fetch user details based on role
          if (!(req.role === "admin")) {
            _context5.next = 9;
            break;
          }
...
router.get("/:courseId/students", /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    var courseId, students;
