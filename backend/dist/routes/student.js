...
var _student = _interopRequireDefault(require("../middleware/student.js"));
...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // Middleware to check if the user is a student
var router = _express["default"].Router();

// Middleware to ensure the user is a student
router.use(_auth["default"]); // Ensure the user is authenticated
router.use(_student["default"]); // Ensure the user is a student

// View attendance records for the logged-in student
router.get("/attendance", /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          }).populate("course_id", "course_name").select("course_id date status");
        case 3:
          attendanceRecords = _context.sent;
          res.status(200).json({
...
router.get("/notifications", /*#__PURE__*/function () {
